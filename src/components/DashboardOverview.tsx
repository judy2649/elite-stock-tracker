        ...
        <div className="bg-white rounded-xl border border-zinc-200 p-5 lg:col-span-8 shadow-xs">
          ...
          <div className="mb-4 p-2.5 bg-royal-50/40 border border-royal-100/60 rounded-lg flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-[11px] text-zinc-600">
            <span className="flex items-center gap-2 font-medium">
              ...
              <span>Dispatched alerts active to: <b className="text-zinc-800 font-mono">sonyaesther8@gmail.com</b>, <b className="text-zinc-800 font-mono">islamnakibinge@gmail.com</b>, <b className="text-zinc-800 font-mono">judithoyoo64@gmail.com</b> and authorized admins.</span>
            </span>
            <button 
